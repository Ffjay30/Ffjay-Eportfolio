...
const sections = [
  {
    ...
    title: "Prelim",
    images: [
      "/course-assets/cpe-c306/prelim/222_1.png",
      "/course-assets/cpe-c306/prelim/223_2.png",
      "/course-assets/cpe-c306/prelim/224_3.png",
      "/course-assets/cpe-c306/prelim/225_4.png",
      "/course-assets/cpe-c306/prelim/226_5.png",
    ],
    externalLink: {
      href: "https://drive.google.com/file/d/1nsEJcc39a1uFCUVlPddjLndq7wOMGxQk/view?usp=drive_link",
      label: "Prelim Project Documentation",
    },
  },
  {
    id: "midterm",
    ...
    title: "Midterm",
    images: [
      "/course-assets/cpe-c306/midterm/217_6.png",
      "/course-assets/cpe-c306/midterm/218_7.png",
      "/course-assets/cpe-c306/midterm/219_Waste Segregation and Composting System Conncept Paper.png",
      "/course-assets/cpe-c306/midterm/220_8.png",
      "/course-assets/cpe-c306/midterm/221_9.png",
    ],
    externalLink: {
      href: "https://drive.google.com/file/d/1DxTABcRMX6JuHGjXE7BH8_k3SMOmbRpE/view?usp=sharing",
      label: "Midterm Project Demo Video",
    },
  },
  {
    id: "finals",
    ...
    title: "Finals",
    images: [
      "/course-assets/cpe-c306/finals/227_10.png",
      "/course-assets/cpe-c306/finals/228_11.png",
      "/course-assets/cpe-c306/finals/229_12.png",
      "/course-assets/cpe-c306/finals/230_13.png",
      "/course-assets/cpe-c306/finals/231_14.png",
    ],
    externalLink: {
      href: "https://drive.google.com/file/d/1xGflAHewJ2Dqns9ZqtEGH2Xnu-mgJMZe/view?usp=sharing",
      label: "Final Project Documentation",
    },
  },
];

export const Microprocessors = () => {
  const [activeSectionId, setActiveSectionId] = useState("prelim");
        ...
        <div className="container mx-auto px-6 md:px-10 lg:px-14 py-16 relative z-10">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
              CPE C306 - Microprocessors
            </h2>

            <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-8 max-w-3xl">
              This page presents my compiled outputs, project materials, and
              academic works for Microprocessors across the prelim, midterm,
              and finals periods.
            </p>
          </div>
