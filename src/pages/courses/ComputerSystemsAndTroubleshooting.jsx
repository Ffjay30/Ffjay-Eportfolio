...
const projectImages = [
  {
    src: "/course-assets/cpe-c204/188_1.png",
    alt: "CPE C204 Academics and Relevant Works Image 1",
  },
  {
    src: "/course-assets/cpe-c204/189_2.png",
    alt: "CPE C204 Academics and Relevant Works Image 2",
  },
  {
    src: "/course-assets/cpe-c204/190_3.png",
    alt: "CPE C204 Academics and Relevant Works Image 3",
  },
  {
    src: "/course-assets/cpe-c204/191_4.png",
    alt: "CPE C204 Academics and Relevant Works Image 4",
  },
  {
    src: "/course-assets/cpe-c204/192_5.png",
    alt: "CPE C204 Academics and Relevant Works Image 5",
  },
  {
    src: "/course-assets/cpe-c204/193_6.png",
    alt: "CPE C204 Academics and Relevant Works Image 6",
  },
  {
    src: "/course-assets/cpe-c204/194_7.png",
    alt: "CPE C204 Academics and Relevant Works Image 7",
  },
  {
    src: "/course-assets/cpe-c204/195_8.png",
    alt: "CPE C204 Academics and Relevant Works Image 8",
  },
];

export const ComputerSystemsAndTroubleshooting = () => {
        ...
        <div className="container mx-auto px-6 md:px-10 lg:px-14 py-16 relative z-10">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
              CPE C204 - Computer Systems and Troubleshooting
            </h2>
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-8 max-w-3xl">
              ...
              and relevant works for Computer Systems and Troubleshooting.
            </p>
          </div>
