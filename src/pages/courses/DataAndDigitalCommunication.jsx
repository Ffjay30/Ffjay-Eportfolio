...
const projectImages = [
  {
    src: "/course-assets/cpe-c303/207_1.png",
    alt: "CPE C303 Academics and Relevant Works Image 1",
  },
  {
    src: "/course-assets/cpe-c303/208_2.png",
    alt: "CPE C303 Academics and Relevant Works Image 2",
  },
  {
    src: "/course-assets/cpe-c303/209_3.png",
    alt: "CPE C303 Academics and Relevant Works Image 3",
  },
  {
    src: "/course-assets/cpe-c303/210_4.png",
    alt: "CPE C303 Academics and Relevant Works Image 4",
  },
  {
    src: "/course-assets/cpe-c303/211_5.png",
    alt: "CPE C303 Academics and Relevant Works Image 5",
  },
  {
    src: "/course-assets/cpe-c303/212_6.png",
    alt: "CPE C303 Academics and Relevant Works Image 6",
  },
  {
    src: "/course-assets/cpe-c303/213_7.png",
    alt: "CPE C303 Academics and Relevant Works Image 7",
  },
  {
    src: "/course-assets/cpe-c303/214_8.png",
    alt: "CPE C303 Academics and Relevant Works Image 8",
  },
  {
    src: "/course-assets/cpe-c303/215_9.png",
    alt: "CPE C303 Academics and Relevant Works Image 9",
  },
  {
    src: "/course-assets/cpe-c303/216_10.png",
    alt: "CPE C303 Academics and Relevant Works Image 10",
  },
];

export const DataAndDigitalCommunication = () => {
        ...
        <div className="container mx-auto px-6 md:px-10 lg:px-14 py-16 relative z-10">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
              CPE C303 - Data and Digital Communication
            </h2>
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-8 max-w-3xl">
              ...
              and relevant works for Data and Digital Communication.
            </p>
          </div>
          ...
          <div className="mt-14 rounded-[2rem] border border-border bg-card p-8 shadow-sm">
            ...
            <p className="mt-4 text-muted-foreground leading-7 max-w-2xl">
              You can view the video presentation for this course through the
              external link below.
            </p>

            <div className="mt-6">
              <a
                href="https://drive.google.com/file/d/1CfdzNS3xgqfI7mREs8RgH1XkdHwAkCG_/view?usp=sharing"
                target="_blank"
